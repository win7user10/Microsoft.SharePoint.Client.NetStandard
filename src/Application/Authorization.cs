namespace Microsoft.SharePoint.Client.NetStandard.Application
{
  ...
  public class SharePointAuthorization
  {
    ...
    public SharePointAuthorization(string token)
    {
    ...
    public SharePointAuthorization(string token, bool finished)
    {
      this.m_Message = ValidationHelper.MakeStringNull(token);
    ...
    public SharePointAuthorization(string token, bool finished, string connectionGroupId) : this(token, finished, connectionGroupId, false)
    {
    }

    internal SharePointAuthorization(string token, bool finished, string connectionGroupId, bool mutualAuth)
    {
      this.m_Message = ValidationHelper.MakeStringNull(token);
